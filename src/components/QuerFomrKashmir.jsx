...
const TourQueryFormKashmir = () => {
  ...
  const adventureDestinations = [
   "Gulmarg Ski Adventure ", "Pahalgam Valley Retreat" , "Dal Lake Houseboat Stay" ,"Sonmarg Mountain Escape ","Mughal Garden Tour "," Leh-Ladakh Expedition"
  ];
      ...
      <div className="bg-gradient-to-r from-orange-600 to-orange-500 rounded-lg shadow-lg p-6 mb-8 text-white">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-4 md:mb-0">
            <h2 className="text-2xl font-bold">🔥 FLASH SALE: SPECIAL OFFER: 20% OFF ALL KASHMIR TOURS"</h2>
            <p className="text-white text-opacity-90">Book your Kashmir getaway within 48 hours and enjoy 20% off + FREE local experience package!"</p>
          </div>
...
export default TourQueryFormKashmir;