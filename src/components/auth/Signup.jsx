...
const Signup = ({ onClose, switchToLogin }) => {
  ...
  return (
    <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg w-full max-w-md mx-auto">
      <h2 className="text-lg sm:text-xl font-bold text-center mb-3 text-gray-800">Create an Account</h2>
      
      {error && (
        <div className="bg-red-100 border border-red-400 text-red-700 px-3 py-1.5 rounded mb-3 text-xs sm:text-sm">
          {error}
        </div>
      )}
      
      {success && (
        <div className="bg-green-100 border border-green-400 text-green-700 px-3 py-1.5 rounded mb-3 text-xs sm:text-sm">
          Registration successful! Redirecting to login...
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-2.5">
        <div>
          ...
          <input
            className="w-full px-2.5 py-1.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500 text-sm"
            id="name"
            type="text"
            name="name"
            value={formData.name}
        ...
        <div>
          <label className="block text-gray-700 text-xs font-medium mb-1" htmlFor="signup-email">
            Email
          </label>
          <input
            className="w-full px-2.5 py-1.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500 text-sm"
        ...
        <div>
          <label className="block text-gray-700 text-xs font-medium mb-1" htmlFor="signup-password">
            Password
          </label>
          <input
            className="w-full px-2.5 py-1.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500 text-sm"
        ...
        <div>
          <label className="block text-gray-700 text-xs font-medium mb-1" htmlFor="confirmPassword">
            Confirm Password
          </label>
          <input
            className="w-full px-2.5 py-1.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500 text-sm"
        ...
        <div>
          <label className="flex items-start cursor-pointer">
            <input
              type="checkbox"
              className="h-3.5 w-3.5 text-orange-500 border-gray-300 rounded focus:ring-1 focus:ring-orange-500 mt-0.5"
              name="agreeToTerms"
              checked={formData.agreeToTerms}
              onChange={handleChange}
              required
        ...
        <button
          type="submit"
          className="w-full bg-orange-500 hover:bg-orange-600 text-white font-medium py-1.5 px-4 rounded-md focus:outline-none focus:ring-1 focus:ring-orange-500 focus:ring-opacity-50 transition duration-150 mt-3 text-sm"
          disabled={loading}
        >
          {loading ? 'Creating Account...' : 'Create Account'}
        </button>
      ...
      {/* Reviews section - hidden on desktop, visible on mobile */}
      <div className="mt-3 p-2 bg-gray-50 rounded-md border border-gray-200 md:hidden">
        <h3 className="text-center font-bold text-xs text-gray-800 mb-2">Book With Confidence</h3>
        
        <div className="grid grid-cols-2 gap-1.5">
          <div className="flex flex-col items-center p-1.5 bg-white rounded shadow-sm">
            <div className="flex items-center">
              <span className="text-xs font-bold text-orange-500">4.5/5</span>
          ...
          <div className="flex flex-col items-center p-1.5 bg-white rounded shadow-sm">
            <div className="flex items-center">
              <span className="text-xs font-bold text-orange-500">4.0/5</span>
              <div className="flex ml-0.5">
                {[1, 2, 3, 4].map(i => (
                  <svg key={i} className="w-2.5 h-2.5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118l-2.8-2.034c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
          ...
          <div className="flex flex-col items-center p-1.5 bg-white rounded shadow-sm">
            <div className="flex items-center">
              <span className="text-xs font-bold text-orange-500">4.4/5</span>
              <div className="flex ml-0.5">
                {[1, 2, 3, 4].map(i => (
                  <svg key={i} className="w-2.5 h-2.5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118l-2.8-2.034c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
          ...
          <div className="flex flex-col items-center p-1.5 bg-white rounded shadow-sm">
            <div className="flex items-center">
              <span className="text-xs font-bold text-orange-500">4.3/5</span>
              <div className="flex ml-0.5">
                {[1, 2, 3, 4].map(i => (
                  <svg key={i} className="w-2.5 h-2.5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118l-2.8-2.034c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
  ...
  // return (
  //   <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-lg w-full max-w-md mx-auto overflow-y-auto">
  ...
  //         </label>
  //         <input
  //           className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-sm sm:text-base"
  //           id="name"
  //           type="text"
  //           name="name"
  //           value={formData.name}
  ...
  //       <button
  //         type="submit"
  //         className="w-full bg-orange-500 hover:bg-orange-600 text-white font-medium py-2 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50 transition duration-150 mt-4"
  //         disabled={loading}
  //       >
  //         {loading ? 'Creating Account...' : 'Create Account'}
  //       </button>
  ...
  //     {/* Reviews section - hidden on desktop, visible on mobile */}
  //     <div className="mt-6 p-3 bg-gray-50 rounded-lg border border-gray-200 md:hidden">
  //       <h3 className="text-center font-bold text-sm text-gray-800 mb-3">Book With Confidence</h3>
        
  //       <div className="grid grid-cols-2 gap-2">
  //         <div className="flex flex-col items-center p-2 bg-white rounded shadow-sm">
  //           <div className="flex items-center mb-1">
  //             <span className="text-sm font-bold text-orange-500">4.5/5</span>
  ...
  //         <div className="flex flex-col items-center p-2 bg-white rounded shadow-sm">
  //           <div className="flex items-center mb-1">
  //             <span className="text-sm font-bold text-orange-500">4.0/5</span>
  //             <div className="flex ml-1">
  //               {[1, 2, 3, 4].map(i => (
  //                 <svg key={i} className="w-3 h-3 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
  //                   <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118l-2.8-2.034c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
  ...
  //         <div className="flex flex-col items-center p-2 bg-white rounded shadow-sm">
  //           <div className="flex items-center mb-1">
  //             <span className="text-sm font-bold text-orange-500">4.4/5</span>
  //             <div className="flex ml-1">
  //               {[1, 2, 3, 4].map(i => (
  //                 <svg key={i} className="w-3 h-3 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
  //                   <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118l-2.8-2.034c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
  ...
  //         <div className="flex flex-col items-center p-2 bg-white rounded shadow-sm">
  //           <div className="flex items-center mb-1">
  //             <span className="text-sm font-bold text-orange-500">4.3/5</span>
  //             <div className="flex ml-1">
  //               {[1, 2, 3, 4].map(i => (
  //                 <svg key={i} className="w-3 h-3 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
  //                   <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118l-2.8-2.034c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
