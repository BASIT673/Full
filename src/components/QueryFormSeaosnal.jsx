      ...
      <div className="bg-gradient-to-r from-orange-600 to-orange-500 rounded-lg shadow-lg p-6 mb-8 text-white">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-4 md:mb-0">
            <h2 className="text-2xl font-bold">🔥 FLASH SALE: SPECIAL OFFER – 20% OFF ALL SEASONAL TOURS!</h2>
...
export default TourQueryFormSeasonal;